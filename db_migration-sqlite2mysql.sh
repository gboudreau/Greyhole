...
hda-create-db-and-user greyhole3
mysql -u greyhole3 -pgreyhole3 greyhole3 < /usr/share/greyhole/schema-mysql.sql
echo "Done."
echo
...
mysql -u greyhole3 -pgreyhole3 -e 'truncate settings' greyhole3
mysql -u greyhole3 -pgreyhole3 greyhole3 < greyhole.dump.sql
